...
docker run --rm \
  ...
  ceyoniq.azurecr.io/release/nscale/application-layer:ubi.10.2.1001.2026032821
```
...
```bash
docker run ... -v ${PWD}/fonts:/usr/share/fonts/truetype/msttcorefont:ro ceyoniq.azurecr.io/release/nscale/application-layer:ubi.10.2.1001.2026032821
```
