...
docker run --rm \
  ...
  -e NSCALE_PORT=8080 \
  -p 8090:8090 \
  ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.9.1.1500.2024022216
```
...
$ docker create ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.9.1.1500.2024022216[version]  # Passen Sie bitte diese Version an
