...
docker run --rm \
  ...
  -e NSCALE_PORT=8080 \
  ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.9.3.1201.2024112811
```
...
$ docker create ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.9.3.1201.2024112811[version]  # Passen Sie bitte diese Version an
