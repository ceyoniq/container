...
docker run --rm \
  ...
  -e NSCALE_PORT=8080 \
  ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.10.1.1301.144885
```
...
$ docker create ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.10.1.1301.144885[version]  # Passen Sie bitte diese Version an
