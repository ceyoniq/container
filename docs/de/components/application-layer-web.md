...
docker run --rm \
  ...
  -e NSCALE_PORT=8080 \
  -p 8090:8090 \
  ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.9.0.1300.2023062720
```
...
$ docker create ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.9.0.1300.2023062720[version]  # Passen Sie bitte diese Version an
