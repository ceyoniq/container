...
docker run --rm \
  ...
  -e NSCALE_PORT=8080 \
  -p 8090:8090 \
  ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.9.2.1100.2024042511
```
...
$ docker create ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.9.2.1100.2024042511[version]  # Passen Sie bitte diese Version an
