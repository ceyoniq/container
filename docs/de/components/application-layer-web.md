...
docker run --rm \
  ...
  -e NSCALE_PORT=8080 \
  ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.10.0.1400.103524
```
...
$ docker create ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.10.0.1400.103524[version]  # Passen Sie bitte diese Version an
