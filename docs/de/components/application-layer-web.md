...
docker run --rm \
  ...
  -e NSCALE_PORT=8080 \
  -p 8090:8090 \
  ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.9.1.1200.2023112413
```
...
$ docker create ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.9.1.1200.2023112413[version]  # Passen Sie bitte diese Version an
