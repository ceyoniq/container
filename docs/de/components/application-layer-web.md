...
docker run --rm \
  ...
  -e NSCALE_PORT=8080 \
  ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.10.1.1501.158336
```
...
$ docker create ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.10.1.1501.158336[version]  # Passen Sie bitte diese Version an
