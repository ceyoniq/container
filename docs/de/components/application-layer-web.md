...
docker run --rm \
  ...
  -e NSCALE_PORT=8080 \
  ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.9.3.1501.2025022612
```
...
$ docker create ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.9.3.1501.2025022612[version]  # Passen Sie bitte diese Version an
