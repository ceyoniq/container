...
docker run --rm \
  ...
  -e NSCALE_PORT=8080 \
  ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.9.2.1400.2024072410
```
...
$ docker create ceyoniq.azurecr.io/release/nscale/application-layer-web:ubi.9.2.1400.2024072410[version]  # Passen Sie bitte diese Version an
