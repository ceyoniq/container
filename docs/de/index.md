...
|:---|:---|:---|
| ceyoniq.azurecr.io/release/nscale/application-layer | <application-layer-tag>8.4.1402.2023013016</application-layer-tag> | [nscale Server Application Layer](components/application-layer.md) |
| ceyoniq.azurecr.io/release/nscale/application-layer-web | <application-layer-web-tag>8.4.1400.2023012514</application-layer-web-tag> | [nscale Server Application Layer Web](components/application-layer-web.md) |
| ceyoniq.azurecr.io/release/nscale/storage-layer | <storage-layer-tag>8.4.1400.2023011810</storage-layer-tag> | [nscale Server Storage Layer](components/storage-layer.md) |
| ceyoniq.azurecr.io/release/nscale/rendition-server | <rendition-server-tag>8.4.1400.2023011609</rendition-server-tag> | [nscale Rendition Server](components/rendition-server.md) |
| ceyoniq.azurecr.io/release/nscale/console | <console-tag>8.4.1401.12950</console-tag> | [nscale Console](components/console.md) |
| ceyoniq.azurecr.io/release/nscale/monitoring-console | <monitoring-console-tag>8.4.1400.2023011609</monitoring-console-tag> | [nscale Monitoring Console](components/monitoring-console.md) |
| ceyoniq.azurecr.io/release/nscale/pipeliner | <pipeliner-tag>8.4.1402.2023013108</pipeliner-tag> | [nscale Pipeliner](components/pipeliner.md) |
| ceyoniq.azurecr.io/release/nscale/cmis-connector | <cmis-connector-tag>8.4.1400.2023011716</cmis-connector-tag> | [nscale CMIS-Connector](components/cmis-connector.md) |
...
| ceyoniq.azurecr.io/release/nscale/xta-connector | <xta-connector-tag>8.4.1001.2022122017</xta-connector-tag> | [nscale XTAConnector](components/xta-connector.md) |
| ceyoniq.azurecr.io/release/nscale/administrator | <administrator-tag>8.4.1400.2023011119</administrator-tag> | [nscale Administrator](components/administrator.md) |
